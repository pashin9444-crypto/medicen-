...
function buildOrderEmails(o) {
  ...
  const buyer = {
    ...
    text: "Thank you for your order!\n\nEvery extract is hand-made in small batches, so yours is " +
      "prepared with real care before it ships.\n\nHere's what you ordered:\n" + itemsText +
      "\n\nTotal: " + total + "\nShips by " + shipBy + " to:\n" + addr.text +
      "\n\nQuestions? Just reply to this email.\n— Serena & the Living Terrain team\n\n" + fda,
    html: wrap('<h2 style="color:#2f3d2c">Your order is confirmed 🌿</h2>' +
      "<p>Thank you for your order! Every extract is hand-made in small batches, so yours is prepared with real care before it ships.</p>" +
      itemsHtml +
